with open("economic-indicators.csv", "r") as boston:
    ...
    ano_usuario = input("Qual ano ddeseja pesquisar: ")
    ...
    print(f"O mês/ano de maior movimento no aeroporto foi: {ano}/{mes}.")
    print("O total de passageiros do ano: ", total_passageiros)
    print(f"O mês do ano {ano_usuario} com maior média para diarias de hotel foi {mes_maior_diaria}")